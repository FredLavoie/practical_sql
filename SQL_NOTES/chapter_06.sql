...
-- ************************************************************************************************************************
-- Queries to set up join exercises
...
-- Join employees and departments tables department ID key
-- This is an INNER JOIN (or just JOIN)
SELECT *
FROM departments JOIN employees
ON departments.dept_id = employees.dept_id;

-- ************************************************************************************************************************
-- Examples for LEFT JOIN, RIGHT JOIN, FULL OUTER JOIN & CROSS JOIN
...
-- ************************************************************************************************************************
-- Join exercies using couties data
